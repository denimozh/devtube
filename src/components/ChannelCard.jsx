...
const ChannelCard = ({ channelDetail, padding }) => {
  return (
    <div className='  width-[358px] border-0 rounded-[20px] flex content-center items-center justify-center'>
      <Link to={`/channel/${channelDetail?.id?.channelId}`}>
        <div className={`text-center text-white align-middle flex flex-col items-center justify-center ${padding}`}>
